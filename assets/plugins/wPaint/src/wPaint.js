(function ($) {
  ...
  Paint.prototype = {
    ...
    getImage: function (withBg) {
      ...
      if (withBg) { ctxSave.drawImage(this.canvasBg, 0, 0, canvasSave.width, canvasSave.height); }
      ctxSave.drawImage(this.canvas, 0, 0, canvasSave.width, canvasSave.height);
